...
//   src/font-split.css             —— @font-face + unicode-range，URL 已改为站点绝对路径
...
const input = path.join(appRoot, 'src', 'assets', 'fonts', 'AlimamaFangYuanTi.otf');
const outDir = path.join(appRoot, 'public', 'fonts', 'fangyuan');
const cssTarget = path.join(appRoot, 'src', 'font-split.css');
