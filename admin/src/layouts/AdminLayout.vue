...
<template>
  <el-container class="h-screen">
    ...
    <el-aside
      width="220px"
      class="bg-rocom-bg-parchment border-r border-rocom-outline transition-transform lg:translate-x-0 fixed lg:relative z-50 h-full"
      :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
    >
      <div class="h-16 flex items-center justify-between px-4">
        <span class="font-bold text-lg text-rocom-text-strong tracking-wider">YeYi 管理后台</span>
    ...
    <el-container>
      <el-header class="h-16 flex items-center justify-between border-b border-rocom-outline bg-rocom-surface-paper px-4 lg:px-6">
      ...
      <el-main id="main-content" class="bg-rocom-bg p-4 lg:p-6">
        <router-view />
      </el-main>
    </el-container>
  </el-container>
